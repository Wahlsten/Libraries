classdef scheme_obj
    ...
    methods
        function obj = createAMatrix(obj, grid_obj, sbp_obj)
            ...
            obj.Scheme.E_0          = zeros(grid_obj.N(1) + 1);
            obj.Scheme.E_0(1,1)     = 1;
            obj.Scheme.E_N          = zeros(grid_obj.N(1) + 1);
            obj.Scheme.E_N(end,end) = 1;
            obj.Scheme.PinvENSigmaE = sparse(sbp_obj.Pinv * obj.Sigma.E * obj.Scheme.E_N);
            obj.Scheme.PinvE0SigmaW = sparse(sbp_obj.Pinv * obj.Sigma.W * obj.Scheme.E_0);
